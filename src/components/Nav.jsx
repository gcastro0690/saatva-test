...
const Nav = ({cartCount}) => (
  <div className="nav container-fluid">
    <div className="container h-100 d-flex flex-row justify-content-between align-items-center">
      <svg
        name="saatvaLogo"
        className="icon nav__saatvaLogo"
        role="img"
        alt="Saatva Logo"
      ...
      <div>
        <AiOutlineShoppingCart className="nav__shoppingCart" />
        <span data-testid="cart-counter" className="nav__cartBubble d-flex justify-content-center align-items-center">
          {cartCount}
        </span>
      </div>
    </div>
